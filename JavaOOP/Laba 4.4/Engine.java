public class Engine {
    ...
    public void Show(){
        ...
        System.out.println("Вид двигателя:");
        if(this.TypeFuel==Topl.GreenSteam){System.out.println(" GreenSteam");}
        else if(this.TypeFuel==Topl.Vtip){System.out.println(" Vtip");}
        else if(this.TypeFuel==Topl.Radical){System.out.println(" Radical");}
