...
public class Car {
    ...
    public Car(String Brand_,Views View_, String Color_, int EnginePower_, int NumWheels_) {
        this.Brand = Brand_;
        this.View = View_;
        this.Color = Color_;
        this.EnginePower = EnginePower_;
        this.NumWheels = NumWheels_;
    }
    public Car(String Brand_,Views View_, String Color_, int EnginePower_, int NumWheels_, String Regnum_) {
        this.Brand = Brand_;
        this.View = View_;
        this.Color = Color_;
        this.EnginePower = EnginePower_;
    ...
    public void Show(){
       ...
       if(this.View==Views.Passenger){System.out.println(" Легковой");}
        ...
        System.out.printf(" Мощность: %d",this.EnginePower);
